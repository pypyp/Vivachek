...
from common.yaml_util import \
    clear_yaml, write_yaml, read_yaml, read_csv, read_bastase_sql
from testCase.get_basic import zy, zy_temp, qc_record
...
from common.yaml_util import load
...
def login():
    ...
    try:
        ...
        logger.log_info.error(e, "请检查请求头、请求地址或者后台服务是否正常")
